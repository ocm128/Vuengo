...
<div class="hello">
  ...
  <div class="columns">
    <div class="column is-one-third is-offset-one-third">
      <form v-on:submit.prevent="addTask">
        <!-- v-on:submit.prevent="addTask" calls the function addTask on submit -->
        ...
        <div class="field">
          ...
          <div class="control">
            ...
            <!-- Connects this field to the description variable -->
          </div>
        </div>
  ...
  <div class="columns">
    <div class="column is-half">
      <h2 class="subtitle"><strong>Todo</strong></h2>

      <div class="todo">
        <div class="card" v-for="task in tasks" v-if="task.status == 0">
          <!-- Loop through the tasks array, if status is 0 (to do) then we'll show it. -->
    ...
    <div class="column is-half">
      <h2 class="subtitle"><strong>Done</strong></h2>

      <div class="done">
        <div class="card" v-for="task in tasks" v-if="task.status == 1">
          <!-- Loop through the tasks array, if status is 1 (done) then we'll show it. -->
          <div class="card-content">
            <div class="content">
              {{ task.description }}
            </div>
...
.select,
select {
  /* 100% width for the select */
  width: 100%;
}

.card {
  /* Adding some air under the tasks */
  margin-bottom: 25px;
}

.done {
  /* Make the done tasks a little bit transparent */
  opacity: 0.3;
}
</style>
